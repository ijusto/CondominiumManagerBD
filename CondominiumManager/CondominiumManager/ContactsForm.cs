...
namespace CondominiumManager
{
    public partial class ContactsForm : Form
    {
        ...
        private void Fill_Serv_Prov_Contacts()
        {
            ...
            Serv_Providers_listBox.Items.Clear();
            cn.Open();
            cmd = new SqlCommand("showcomplaints", cn) //show_serv_prov_contacts TODO
            {
                CommandType = CommandType.StoredProcedure
            };
            ...
            foreach (DataRow dr in dt.Rows)
            {
                spList.Add(new Services_Provider(dr["NIF"].ToString(), dr["Nome"].ToString(), dr["Telemovel"].ToString(), dr["Morada"].ToString(), dr["tipo"].ToString(), sp_index));
                Serv_Providers_listBox.Items.Add(dr["Descricao"].ToString());
                sp_index++;
            }
            cn.Close();
            */
